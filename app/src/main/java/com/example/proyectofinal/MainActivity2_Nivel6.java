...
public class MainActivity2_Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Nivel 4 - Sumas, Restas y Multiplicaciones",Toast.LENGTH_SHORT).show();
    ...
    public void Comparar (View view2) {
            ...
            if (resultado == respuesta_jugador) {
                ...
                switch (vidas){
                    ...
                    case 2:
                        ...
                        break;
                    case 1:
                        Toast.makeText(this,"Te quedan 1 manzana",Toast.LENGTH_SHORT).show();
                        iv_vidas.setImageResource(R.drawable.unavida);
                        break;
                    case 0:
